...
// interface IControlsInterface {
//     postComments: number;
//     postKarma: number;
// }
//
// export function Controls({postComments, postKarma}: IControlsInterface) {
//     return (
...
//                         fill="#C4C4C4"/>
//                 </svg>
//                 <span className={styles.commentsNumber}>{postComments}</span>
//             </button>
    ...
    return (
        <div className={styles.controls}>
            ...
            <button className={styles.commentsButton}>
                ...
                <span className={styles.commentsNumber}>123</span>
            </button>
            <div className={styles.actions}>
                <button className={styles.shareButton}>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
